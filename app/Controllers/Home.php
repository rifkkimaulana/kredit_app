...
class Home extends BaseController
{
	...
	public function userProfile_postUpdate()
	{
		...
		return redirect()->to(base_url('profile'))->with('success', 'User' . ' ' . $user['user_nama'] . ' ' . 'berhasil diperbarui.');
	}
	...
	public function pengaturan_post()
	{
		$data = [
		...
		return redirect()->to(base_url('pengaturan'))->with('success', 'Pengaturan berhasil diperbarui.');
	}
	...
	public function user_postUpdate()
	{
		...
		return redirect()->to(base_url('users'))->with('success', 'User' . ' ' . $user['user_nama'] . ' ' . 'berhasil diperbarui.');
	}
	...
	public function deleteUsers($userId)
	{
		...
		if ($user) {
			...
			return redirect()->to(base_url('users'))->with('success', 'Pengguna berhasil dihapus.');
		} else {
	...
	public function whatsappApiSetting_update()
	{
		...
		return redirect()->to(base_url('whatsapp_api_setting'))->with('success', 'Konfigurasi berhasil diperbarui.');
	}
	...
	public function settingApiGoogle_post()
	{
		...
		return redirect()->to(base_url('setting/google_api'))->with('success', 'Api Google Login anda berhasil diperbarui.');
	}
